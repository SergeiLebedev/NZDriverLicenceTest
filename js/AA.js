!function (n, t) {
    ...
    p = function (n) {
        ...
        var it, r, t, st, oi, wt, ht, y, rt, p, e, v, l, o, g, ct, et, f = "sizzle" + -new Date, s = n.document, a = 0,
            bi = 0, si = ni(), hi = ni(), ci = ni(), bt = function (n, t) {
                return n === t && (rt = !0), 0
            }, ut = "undefined", li = -2147483648, ki = {}.hasOwnProperty, w = [], di = w.pop, gi = w.push, b = w.push,
    ...
    var rt, pt, uo = /^(?:toggle|show|hide)$/, nf = new RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"),
        fo = /queueHooks$/, wt = [eo], st = {
            "*": [function (n, t) {
                var f = this.createTween(n, t), s = f.cur(), r = nf.exec(t), e = r && r[3] || (i.cssNumber[n] ? "" : "px"),
                    u = (i.cssNumber[n] || "px" !== e && +s) && nf.exec(i.css(f.elem, n)), o = 1, h = 20;
                if (u && u[3] !== e) {
                    e = e || u[3];
                    r = r || [];
                    u = +s || 1;
...
!function (n) {
    ...
    n.modal = function (i, r) {
        n.modal.close();
        var f, u;
        if (this.$body = n("body"), this.options = n.extend({}, n.modal.defaults, r), this.options.doFade = !isNaN(parseInt(this.options.fadeDuration, 10)), i.is("a")) if (u = i.attr("href"), /^#/.test(u)) {
            if (this.$elm = n(u), 1 !== this.$elm.length) return null;
            this.open()
            ...
            t && (i.trigger(n.modal.AJAX_SUCCESS), t.$elm.empty().append(r).on(n.modal.CLOSE, f), t.hideSpinner(), t.open(), i.trigger(n.modal.AJAX_COMPLETE))
        }).fail(function () {
    ...
    n.modal.prototype = {
        constructor: n.modal, open: function () {
            var t = this;
            this.options.doFade ? (this.block(), setTimeout(function () {
                t.show()
            }, this.options.fadeDuration * this.options.fadeDelay)) : (this.block(), this.show());
            this.options.escapeClose && n(document).on("keydown.modal", function (t) {
                27 == t.which && n.modal.close()
            });
            ...
            this.options.doFade && this.blocker.animate({opacity: this.options.opacity}, this.options.fadeDuration);
    ...
    n.fn.modal = function (i) {
        return 1 === this.length && (t = new n.modal(this, i)), this
    };
